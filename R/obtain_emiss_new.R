...
#'
#' \code{obtain_emiss_new} obtains the emission distribution for an object
...
#'
#' @return \code{obtain_emiss_new} creates an object of the class \code{mHMM_emiss}.
...
#' obtain_emiss_new(out_2st, level = "group")
#' obtain_emiss_new(out_2st, level = "subject")
#'
#' }
#'
#' @export

...
#'
#' \code{obtain_gamma_new} obtains the transition probability matrix for a
...
#'   \code{mHMM_vary}, generated by the function \code{mHMM},
#'   \code{mHMM_cont} or \code{mHMM_vary}, respectively.
...
#'
#' @return \code{obtain_gamma_new} returns the object \code{est_gamma} of the class
...
#' out_2st <- mHMMbayes::mHMM(s_data = mHMMbayes::nonverbal,
...
#' obtain_gamma_new(out_2st, level = "group")
#' obtain_gamma_new(out_2st, level = "subject")
#'
#' }
#'
#' @export
